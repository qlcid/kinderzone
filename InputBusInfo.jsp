            ...
            <div class="col-md-12">
              <div class="row probootstrap-gutter0">
                ...
                <div class="col-md-7 col-md-push-1  probootstrap-animate" id="probootstrap-content">
                  <H3 align=center>차량스케줄을 입력하세요.</H3>
                  <FORM ACTION=InputBusBack.jsp METHOD=POST>
                    <ul id="form">
                      <li>
                        <ul class="cols">
                          <li class="col1">유치원이름 :</li>
                          <li class="col2" align="left"><INPUT TYPE=TEXT NAME=k_name SIZE=10></li>
                        </ul>
                      </li>
                      <li>
                        <ul class="cols">
                          <li class="col1">기사이름 :</li>
                          <li class="col2" align="left"><INPUT TYPE=TEXT NAME=d_name SIZE=10></li>
                        </ul>
                      </li>
                      <li>
                        <ul class="cols">
                          <li class="col1">아이이름 :</li>
                          <li class="col2" align="left"><INPUT TYPE=TEXT NAME=name SIZE=10></li>
                        </ul>
                      </li>
                      <li>
                        <ul class="cols">
                          <li class="col1">요일 :</li>
                          <li class="col2" align="left">
                            <SELECT NAME="day">
                      ...
                      <li>
                        <ul class="cols">
                          ...
                          <li>타는 곳 :</li>
                          <li><INPUT TYPE=TEXT NAME=place1 size=10></li>
                        </ul>
                      </li>
                      <li>
                        <ul class="cols">
                          ...
                          <li>타는 곳 :</li>
                          <li><INPUT TYPE=TEXT NAME=place2 size=10></li>
                        </ul>
                      </li>
                    </ul>
