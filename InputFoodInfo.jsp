            ...
            <div class="col-md-12">
              <div class="row probootstrap-gutter0">
                ...
                <div class="col-md-7 col-md-push-1  probootstrap-animate" id="probootstrap-content">
                  <H3 align='center'>식단을 입력하세요.</H3>
                  <FORM ACTION=InputFoodBack.jsp METHOD=POST>
                      <div align='center'>
                      <ul id="form">
                        <li>
                          <ul class="cols">
                            <li class="col1">날짜 : </li>
                            <li class="col2" align="left"><INPUT TYPE=DATE NAME=f_date SIZE=30></li>
                          </ul>
                        </li>
                        <li>
                          <ul class="cols">
                            <li class="col1">오늘의 식단 : </li>
                            <li class="col2" align="left"><INPUT TYPE=TEXT NAME=food SIZE=30></li>
                          </ul>
                        </li>
                      </ul>
