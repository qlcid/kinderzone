    ...
    <div class="probootstrap-page-wrapper">
	 ...
	 <li><a href= "#" onclick ="checknotice()">알림장</a></li>
      ...
      <section class="probootstrap-section probootstrap-section-sm">
                 ...
                 <div class="row">
                   <div class="col-md-12"><div class="col-md-12 text-left section-heading probootstrap-animate">
        <div id = center>
        <div class=color onclick="location.href='UserJoin.jsp?user=teacher'" style="cursor:pointer;"><img class = img src = grammar.png /><br/>교사</div>

      <div class=color onclick="location.href='KinderJoin.jsp'" style="cursor:pointer;"><img class = img src = kindergarten.png /><br/>유치원</div>

      <div class=color onclick="location.href='UserJoin.jsp?user=parents'" style="cursor:pointer;"><img class = img src = parents.png /><br/>학부모</div>
      </div>
    </div>
         </div>
       </div>
