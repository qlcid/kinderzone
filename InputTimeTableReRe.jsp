            ...
            <div class="col-md-12">
              <div class="row probootstrap-gutter0">
                ...
                <div class="col-md-7 col-md-push-1  probootstrap-animate" id="probootstrap-content">
                  <FORM ACTION=InputTimeTableUpd.jsp METHOD=POST>
                    <div align="center">
                      반이름: <INPUT TYPE=TEXT NAME=class_name STYLE="border: none; background: transparent;" VALUE=${class_name} DISABLED>
                    </div>
                    <br>
                    <table align="center" border="1" bordercolor="#c0c0c0">
                    <tr align="center">
                          <td width="100" height="30"></td>
                          <td width="100" bgcolor="#eeeeee">월</td>
                          <td width="100" bgcolor="#eeeeee">화</td>
                          <td width="100" bgcolor="#eeeeee">수</td>
                          <td width="100" bgcolor="#eeeeee">목</td>
                          <td width="100" bgcolor="#eeeeee">금</td>
                    </tr>
                    <tr align="center">
                      <td width="100" bgcolor="#eeeeee" height="70" line-height="70">1교시</td>
                    <c:forEach var="first" items="${one}">
                      <td><INPUT TYPE=TEXT NAME=one SIZE=10 VALUE=${first}></td>
                    </c:forEach>
                    </tr>
                    <tr align="center">
                      <td width="100" bgcolor="#eeeeee" height="70" line-height="70">2교시</td>
                    <c:forEach var="first" items="${two}">
                      <td><INPUT TYPE=TEXT NAME=two SIZE=10 VALUE=${first}></td>
                    </c:forEach>
                    </tr>
                    <tr align="center">
                      <td width="100" bgcolor="#eeeeee" height="70" line-height="70">3교시</td>
                    <c:forEach var="first" items="${thr}">
                      <td><INPUT TYPE=TEXT NAME=thr SIZE=10 VALUE=${first}></td>
                    </c:forEach>
                    </tr>
                    <tr align="center">
                      <td width="100" bgcolor="#eeeeee" height="70" line-height="70">4교시</td>
                    <c:forEach var="first" items="${fou}">
                      <td><INPUT TYPE=TEXT NAME=fou SIZE=10 VALUE=${first}></td>
                    </c:forEach>
                    </tr>
                    <tr align="center">
                      <td width="100" bgcolor="#eeeeee" height="70" line-height="70">5교시</td>
                    <c:forEach var="first" items="${fiv}">
                      <td><INPUT TYPE=TEXT NAME=fiv SIZE=10 VALUE=${first}></td>
                    </c:forEach>
                    </tr>
                    <tr align="center">
                      <td width="100" bgcolor="#eeeeee" height="70" line-height="70">6교시</td>
                    <c:forEach var="first" items="${six}">
                      <td><INPUT TYPE=TEXT NAME=six SIZE=10 VALUE=${first}></td>
                    </c:forEach>
                    </tr>
                    </table>
                    <br>
