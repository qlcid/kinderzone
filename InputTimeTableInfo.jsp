            ...
            <div class="col-md-12">
              <div class="row probootstrap-gutter0">
                ...
                <div class="col-md-7 col-md-push-1  probootstrap-animate" id="probootstrap-content">
                  <H3>시간표를 입력하세요.</H3>
                  <FORM ACTION=InputTimeTableBack.jsp METHOD=POST>
                      반이름: <INPUT TYPE=TEXT NAME=class_name SIZE=10> <BR>
                      1교시: <INPUT TYPE=TEXT NAME=mon SIZE=10>
                            <INPUT TYPE=TEXT NAME=tue SIZE=10>
                            <INPUT TYPE=TEXT NAME=wed SIZE=10>
                            <INPUT TYPE=TEXT NAME=thu SIZE=10>
                            <INPUT TYPE=TEXT NAME=fri SIZE=10> <BR>

                      2교시: <INPUT TYPE=TEXT NAME=mon SIZE=10>
                            <INPUT TYPE=TEXT NAME=tue SIZE=10>
                            <INPUT TYPE=TEXT NAME=wed SIZE=10>
                            <INPUT TYPE=TEXT NAME=thu SIZE=10>
                            <INPUT TYPE=TEXT NAME=fri SIZE=10> <BR>
                      3교시: <INPUT TYPE=TEXT NAME=mon SIZE=10>
                            <INPUT TYPE=TEXT NAME=tue SIZE=10>
                            <INPUT TYPE=TEXT NAME=wed SIZE=10>
                            <INPUT TYPE=TEXT NAME=thu SIZE=10>
                            <INPUT TYPE=TEXT NAME=fri SIZE=10> <BR>

                      4교시: <INPUT TYPE=TEXT NAME=mon SIZE=10>
                            <INPUT TYPE=TEXT NAME=tue SIZE=10>
                            <INPUT TYPE=TEXT NAME=wed SIZE=10>
                            <INPUT TYPE=TEXT NAME=thu SIZE=10>
                            <INPUT TYPE=TEXT NAME=fri SIZE=10> <BR>

                      5교시: <INPUT TYPE=TEXT NAME=mon SIZE=10>
                            <INPUT TYPE=TEXT NAME=tue SIZE=10>
                            <INPUT TYPE=TEXT NAME=wed SIZE=10>
                            <INPUT TYPE=TEXT NAME=thu SIZE=10>
                            <INPUT TYPE=TEXT NAME=fri SIZE=10> <BR>

                      6교시: <INPUT TYPE=TEXT NAME=mon SIZE=10>
                            <INPUT TYPE=TEXT NAME=tue SIZE=10>
                            <INPUT TYPE=TEXT NAME=wed SIZE=10>
                            <INPUT TYPE=TEXT NAME=thu SIZE=10>
                            <INPUT TYPE=TEXT NAME=fri SIZE=10> <BR><BR>
                      <div align="center">
