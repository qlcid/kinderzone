...
%>
  ...
  <body>
    ...
    <form method="POST" action = pwcheckDelete.jsp>
      <div id=center>
       <div id =c1>
   ...
   <table>
       <tr>
        <td><input type="text" value =${id} readonly style=" font-size:25px; width:300px; height:50px; "/></td>
       </tr>
       <tr>
         <td><br/></td>
       </tr>
       <tr>
        ...
        <td><input type="password" name="pw" placeholder = "rewrite your password"style=" font-size:25px; width:300px; height:50px; "  /></td>
       </tr>
      </table>
      <br/>
      <input type ="submit" class="btn btn-primary" values = 탈퇴/>
      </div>
      </div>
      </div>
