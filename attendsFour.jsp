    ...
    <div class="probootstrap-page-wrapper">
	  ...
	  <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="about.html">유치원정보</a></li>
                  <li><a href="courses.html">선생님정보</a></li>
                </ul>
              </li>
              <li><a href="attends.jsp">출석</a></li>
              <li class="dropdown">
                <a href="#" data-toggle="dropdown" class="dropdown-toggle">키즈</a>
                <ul class="dropdown-menu">
                  <li><a href="about.html">시간표</a></li>
                  <li><a href="courses.html">차량스케줄</a></li>
                  <li><a href="gallery.html">식단표</a></li>
                </ul>
              </li>
              <li><a href="contact.html">상담</a></li>
              <li class="dropdown">
                <a href="#" data-toggle="dropdown" class="dropdown-toggle">마이페이지</a>
                <ul class="dropdown-menu">
                  <li><a href="about.html">내정보</a></li>
                  <li><a href="courses.html">내정보수정</a></li>
                  <li><a href="gallery.html">아이정보수정</a></li>
                  <li><a href="gallery.html">로그아웃</a></li>
                  <li><a href="gallery.html">탈퇴</a></li>
                </ul>
              </li>
            </ul>
          </div>
...

{
 ...
 ResultSet rs2 = null;
  ...
  try{
	...
	out.println("<BR>");
       	sql = "select * from kidsinfo where class_name='"+classname+"';";

	rs = stmt.executeQuery(sql);

	while(rs.next()){
	 kidsid = rs.getString("kids_id");
	 kidsname= rs.getString("kids_name");
	//out.println(""+rs.getString("kids_name")+"<br/>");
	}

	String sql1 = "select * from attendinfo a, kidsinfo b where b.class_name ='"+classname+"' and a.kids_id = b.kids_id;";

	rs2 = stmt.executeQuery(sql1);

	while(rs2.next()){

	kidsid = rs2.getString("kids_name");
	...
	if(cdate.equals(cUseDate)){
		if(abdate!=null){
			out.println(kidsid);
			out.println("&nbsp출석"+abdate+"&nbsp<br/>");
		}else if(atdate!=null){
			out.println(kidsid);
			out.println("&nbsp결석"+atdate+"&nbsp<br/>");
		}else if(ledate!=null){
			out.println(kidsid);
			out.println("&nbsp조퇴"+ledate+"&nbsp<br/>");
		}else{
			out.println("정보없음");}
	}
